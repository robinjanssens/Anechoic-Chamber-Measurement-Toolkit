...
#  Optional arguments: INTERVAL_ANGLE START_ANGLE END_ANGLE
#
...
do
  ...
  do
    mkdir "${RESULT_DIR}${EXPERIMENT_DIR}measurement(pan${i})(tilt${j})"
    FILENAME1="${RESULT_DIR}${EXPERIMENT_DIR}measurement(pan${i})(tilt${j})/antenna0"
    FILENAME2="${RESULT_DIR}${EXPERIMENT_DIR}measurement(pan${i})(tilt${j})/antenna1"
